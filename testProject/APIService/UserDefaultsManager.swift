...
protocol UserDefaultsManagerProtocol: UserDefaults {
	func setHeaterDeviceUserDefaults(key: String, arrayKey: [String], heaterDevice: Heater)
	func setLightDeviceUserDefaults(key: String, arrayKey: [String], lightDevice: Light)
	func setRollerShutterDeviceUserDefaults(key: String, arrayKey: [String], rollerShutterDevice: RollerShutter)
	func checkKeyInUserDefaults(_ key: String, _ device: Device)
	func setUpSliderValue(_ key: String, _ value: Float)
	func setUpSwitchValue(_ key: String, _ value: Bool)
}

final class UserDefaultsManager: UserDefaults, UserDefaultsManagerProtocol {
	// MARK: - Constants
